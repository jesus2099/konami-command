...
function updateTags(event) {
	...
	if (tagZone && tagList) {
		if (!event) {
			getSibling(tagZone, "h2", null, true).appendChild(createTag("span", {s: {color: "black", fontWeight: "normal", "float": "right"}}, ["↙", createTag("span", {s: {backgroundColor: "#ff6"}}, "mine"), " and others’"]));
