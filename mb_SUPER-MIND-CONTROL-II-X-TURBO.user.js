...
function time(_ms) {/*adaptated from 166877*/
	...
	if (ms > 0) {
		...
		return (d.getUTCHours() > 0 ? d.getUTCHours() + ":" : "") + (d.getUTCMinutes() < 10 ? (d.getUTCHours() > 0 ? "0" : "") : "") + d.getUTCMinutes() + ":" + (d.getUTCSeconds() < 10 ? "0" : "") + d.getUTCSeconds() + (d.getUTCMilliseconds() > 0 ? "." + (d.getUTCMilliseconds() < 100 ? "0" : "") + (d.getUTCMilliseconds() < 10 ? "0" : "") + d.getUTCMilliseconds() : "");
	}
	return "?:??";
}
