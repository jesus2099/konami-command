...
// @grant        none
// @match        *://itunes.apple.com/*/album/id*
// @run-at       document-end
// ==/UserScript==
"use strict";
...
a.setAttribute("href", img.getAttribute("src-swap").replace(
    /^(.*\/\/)\w+(\d+.mzstatic.com)\/\w+\/\w+\/(\w+\/\w+\/\w+\/\w+\/\w+\/[\w-]+)\/cover\d+x\d+.jpeg$/,
    "$1is$2/image/thumb/$3/source/99999999x99999999bb-100.jpg"
));
a.appendChild(document.createTextNode("Full size cover image 🔍"));
img.parentNode.parentNode.parentNode.insertBefore(a, img.parentNode.parentNode.nextSibling);
