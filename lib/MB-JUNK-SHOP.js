...
MBJS.displayBanner = function(CONTENT, ADDITIONAL_CLASS, NO_DISMISS, ON_CLOSE_CALLBACK) {
	if (!MBJS.displayBanner_init) {
		MBJS.css.insertRule("." + MBJS.id + ".banner h1 { margin-bottom: 1em; }", 0);
		MBJS.css.insertRule("." + MBJS.id + ".banner p { text-align: left; }", 0);
		MBJS.css.insertRule("." + MBJS.id + ".banner a { text-decoration: underline; font-weight: bold; }", 0);
