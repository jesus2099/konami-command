...
function forceValue(input, value) {
	// Tested OK with input of types: <input> <select> <textarea>
	// Force react state change by bubbling up the input event : https://web.archive.org/web/20230128011329/nattaylor.com/blog/2022/userscripts-and-reactjs-forms/
	input.dispatchEvent(new Event("input", {bubbles: true}));
	// Use native input value setter to bypass React (simple value setter is overridden by react)
	(Object.getOwnPropertyDescriptor(Object.getPrototypeOf(input), "value").set).call(input, value);
	// Without change it was not working, either, in MBS edit artist page, at least
