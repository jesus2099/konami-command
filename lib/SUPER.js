...
// @description  Library of SUPER cool stuff. Not supposed to be used by anyone else than high level scientists. Everchanging. Use it at your own risks.
...
function sendEvent(node, eventName) {
	...
	if (_eventName.match(/^mouse|click$/)) {
		...
		event.initMouseEvent(_eventName, true, true, window, 0, 0, 0, 0, 0, parameters.modifierKeys.indexOf("ctrl") > -1, parameters.modifierKeys.indexOf("alt") > -1, parameters.modifierKeys.indexOf("shift") > -1, parameters.modifierKeys.indexOf("meta") > -1, 0, null);
	}
	else {
