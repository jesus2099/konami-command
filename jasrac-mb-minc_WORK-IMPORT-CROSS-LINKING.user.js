		...
		case "jasrac":
			waitForElement("#management-tabs", function() { // quick and dirty patch
				...
				/* -- vv ------ Add to MB ------ vv -- */
						...
						isVocal = document.querySelector("#management-tabs")?.textContent.indexOf(hasLyrics) > 0;
						if (isVocal) {
...
function setType(type) {
	var slangid = !document.querySelector("select[name='edit-work.languages.1']") && document.querySelector("select[name='edit-work.languages.0']");
