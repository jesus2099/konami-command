...
// @require      https://github.com/jesus2099/konami-command/raw/de88f870c0e6c633e02f32695e32c4f50329fc3e/lib/SUPER.js?version=2022.3.24.224#workaround-github.com/violentmonkey/violentmonkey/issues/1581-jasrac-mb-minc_WORK-IMPORT-CROSS-LINKING
// @grant        none
		...
		case "work":
			if (getExtLinks()) {
				...
				for (let i = 0; i < NexToneIDs.length; i++) {
					var ntid = NexToneIDs[i].textContent.trim();
					replaceElement(createTag("a", {a: {href: workLookupURL("nextone", "code", ntid)}, s: {background: background}}, ntid), NexToneIDs[i].firstChild);
				}
			}
			break;
		case "work/edit":
