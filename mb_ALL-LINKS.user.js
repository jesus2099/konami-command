	...
	items: {
		...
		lyricsDBs: {
			...
			items: {
				...
				"J-Lyric（歌手名）": "//j-lyric.net/search.php?ex=on&ct=2&ca=2&cl=2&ops=2&ka=%artist-name%&search=%E6%A4%9C%E7%B4%A2",
				"J-Lyric（曲名）": [
					"//j-lyric.net/search.php?ex=on&ct=2&ca=2&cl=2&kt=%recording-name%&search=%E6%A4%9C%E7%B4%A2",
					"//j-lyric.net/search.php?ex=on&ct=2&ca=2&cl=2&kt=%work-name%&search=%E6%A4%9C%E7%B4%A2"
				]
			}
		},
		scoreDBs: {
...
var additionalSearchLinks = {
	...
	items: {
		...
		otherDBs: {
			...
			items: {
				GnuDb: [ // new syntax but now GnuDb is almost not responsive at all because of AI attacks
					"https://jesus2099.gitlab.io/forward-request.html?_method=post&_action=https://gnudb.org/search.php&action=search&words=%22%artist-name%%22&mode=artist",
					"https://jesus2099.gitlab.io/forward-request.html?_method=post&_action=https://gnudb.org/search.php&action=search&words=%22%release-artist-credit%%22%20%22%release-name%%22",
					"https://jesus2099.gitlab.io/forward-request.html?_method=post&_action=https://gnudb.org/search.php&action=search&words=%22%release-group-artist-credit%%22%20%22%release-group-name%%22",
					"https://jesus2099.gitlab.io/forward-request.html?_method=post&_action=https://gnudb.org/search.php&action=search&words=%22%recording-name%%22&mode=song",
					"https://jesus2099.gitlab.io/forward-request.html?_method=post&_action=https://gnudb.org/search.php&action=search&words=%22%work-name%%22&mode=song",
				],
				"GnuDb (just title)": [
					"https://jesus2099.gitlab.io/forward-request.html?_method=post&_action=https://gnudb.org/search.php&action=search&words=%22%release-name%%22&mode=album",
					"https://jesus2099.gitlab.io/forward-request.html?_method=post&_action=https://gnudb.org/search.php&action=search&words=%22%release-group-name%%22&mode=album",
				],
				"GnuDb (abc)": [
					"https://jesus2099.gitlab.io/forward-request.html?_method=post&_action=https://gnudb.org/search.php&action=search&words=%22%artist-latin-script-name%%22&mode=artist",
				],
			}
		}
	}
